...
function buildRows(year) {
  ...
  rows.push({
    siteLabel: "South Korea - Seoul (Gangseo University)",
    ...
    exclusions: [
      hold(
        ...
        ymd(year, 7, 1),
        ymd(year, 9, 30),
        "Not listed as available July–September"
      ),
    ],
    teamNotes: [
  ...
  rows.push({
    siteLabel: "South Korea - Seoul (Hangil CofC)",
    availableStart: ymd(year, 3, 1),
    availableEnd: ymd(year, 11, 30),
    exclusions: [
      hold(
        ...
        ymd(year, 4, 1),
        ymd(year, 5, 31),
        "Not listed as available April–May"
      ),
      hold(
        `hangil-jul-oct-${year}`,
        ymd(year, 7, 1),
        ymd(year, 10, 31),
        "Not listed as available July–October"
      ),
    ],
    teamNotes: [
      "Hosts: SunWoo and Serena Shim",
      "Preferred team size: 2",
  ...
  rows.push({
    siteLabel: "Brazil - Niteroi",
    availableStart: "",
    availableEnd: "",
    exclusions: [],
    teamNotes: ["Special site — see staff notes (availability not set yet)."],
    notesOnly: true,
  });
...
const ensureSites = [
  ...
  ["South Korea - Seoul (Gangseo University)", null],
  ["South Korea - Seoul (Hangil CofC)", "SunWoo and Serena Shim"],
  ["Brazil - Niteroi", null],
