    ...
    <Shell>
      ...
      <div className="budgetPage">
        ...
        <div className="card pad" style={{ marginBottom: 24 }}>
          <div
            className="row"
            style={{ marginBottom: 8, alignItems: "flex-start", gap: 16, flexWrap: "wrap" }}
          >
            <div style={{ flex: "1 1 320px", minWidth: 0 }}>
              ...
              <div className="small" style={{ marginTop: 4, color: "var(--muted)", lineHeight: 1.45 }}>
                Autogenerated one row per trip. Primary and extra link/PDF slots also show on each trip&apos;s{" "}
                <strong>Documents → Team housing</strong>. Site notes: <Link href="/sites">Sites</Link>.
              </div>
              {tripsSortedForBudget.length > 0 ? (
                <div
                  className="row"
                  style={{ marginTop: 12, gap: 10, flexWrap: "wrap", alignItems: "flex-end" }}
                >
