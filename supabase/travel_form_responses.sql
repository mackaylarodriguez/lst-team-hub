...
-- Non-partial uniques so INSERT ... ON CONFLICT (trip_id, user_id) works from the API.
-- NULLs are distinct in unique indexes, consistent with owner XOR (one of the two ids set).
