...
export const WORKER_TASK_TEMPLATE = [
  ...
  },
  {
    ...
    title: "$2,000 raised 90 days before trip",
    category: "worker_default",
    dueRule: "fundraising-60",
  },
  {
    id: "worker-task-fundraising-all",
    title: "All raised 30 days before trip",
    category: "worker_default",
    dueRule: "fundraising-30",
  },
  {
    id: "worker-task-thank-donors",
    title: "Thank you to all donors",
    category: "worker_default",
    dueRule: "fundraising-30",
  },
  {
  ...
  },
  {
    ...
    title: "Provided info LST needs for ticketing",
    category: "worker_default",
    dueRule: "pre-departure",
  },
  {
...
export function findWorkerTaskTemplate(task) {
  ...
  return WORKER_TASK_TEMPLATES_BY_TITLE.get(normalizeTaskTitle(task?.title)) || null;
}
