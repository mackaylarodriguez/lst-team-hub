...
const VALUE_STYLE = `color:${EMAIL_BRAND_ACCENT}`;
...
function greenTitleLine(text) {
  return `<p style="margin:0 0 8px;font-size:15px;line-height:1.45;color:${EMAIL_BRAND_ACCENT};font-weight:700">${escapeHtml(text)}</p>`;
}
