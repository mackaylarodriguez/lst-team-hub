/** Training module content and helpers. */
...
export const TRAINING_CENTER_PROTOTYPE_ONSITE_TOOLS_EXPECTATIONS_URL =
  "/training/Expectations_and_Guidelines_for_LST_Workers.pdf";
...
export const TRAINING_CENTER_PROTOTYPE_FUNDRAISING_GUIDE_URL =
  "/training/FundraisingGuide_LST_2026.pdf";
...
const TRAINING_CENTER_PROTOTYPE_MODULE_2_SECTIONS = [
  ...
  {
    id: "m2s-edit-page",
    title: "Fundraising: How to Edit Your Fundraising Page Video",
    dueDate: "2026-07-22",
  ...
  {
    id: "m2s2",
    title: "Fundraising: How We Think About Fundraising Video",
    dueDate: "2026-07-26",
...
const TRAINING_CENTER_PROTOTYPE_MODULE_3_SECTIONS = [
  ...
  {
    id: "m3s2",
    title: "Team Dynamics: Team Work Video",
    dueDate: "2026-08-25",
  ...
  {
    id: "m3s3",
    title: "Team Dynamics: Handling Conflict Video",
    dueDate: "2026-09-01",
  ...
  {
    id: "m3s5",
    title: "Team Dynamics: Handling Conflict",
    dueDate: "2026-09-08",
  ...
  {
    id: "m3s6",
    title: "Team Dynamics: Team Building Activities",
    dueDate: "2026-09-15",
...
const TRAINING_CENTER_PROTOTYPE_MODULE_4_SECTIONS = [
  ...
  {
    id: "m4s2",
    title: "Culture: What is Culture Video",
    dueDate: "2026-08-25",
  ...
  {
    id: "m4s3",
    title: "Culture: Adapting to New Culture Video",
    dueDate: "2026-09-01",
  ...
  {
    id: "m4s5",
    title: "Culture: Adapting to New Culture",
    dueDate: "2026-09-08",
  ...
  {
    id: "m4s6",
    title: "Culture: Culture Exercises",
    dueDate: "2026-09-15",
...
const TRAINING_CENTER_PROTOTYPE_MODULE_5_SECTIONS = [
  ...
  {
    id: "m5s2",
    title: "Making LST Work Onsite: LST Parties Video",
    dueDate: "2026-08-25",
  ...
  {
    id: "m5s7",
    title: "Making LST Work Onsite: LST Parties",
    dueDate: "2026-09-22",
...
${TRAINING_CENTER_PROTOTYPE_ONSITE_HANDOUT_1_CONNECT}`,
  ...
  {
    id: "m5s3",
    title: "Making LST Work Onsite: The Administrative Aspects of Your LST Project Video",
    dueDate: "2026-09-01",
  ...
  {
    id: "m5s8",
    title: "Making LST Work Onsite: The Administrative Aspects of Your Project",
    dueDate: "2026-09-22",
...
${TRAINING_CENTER_PROTOTYPE_ONSITE_HANDOUT_2_WHY}`,
  ...
  {
    id: "m5s4",
    title: "Making LST Work Onsite: Starting and Ending Well Video",
    dueDate: "2026-09-08",
  ...
  {
    id: "m5s9",
    title: "Making LST Work Onsite: Starting and Ending Well",
    dueDate: "2026-09-22",
...
${TRAINING_CENTER_PROTOTYPE_ONSITE_HANDOUT_3_TRAVEL}`,
  ...
  {
    id: "m5s5",
    title: "Making LST Work Onsite: Communication Video",
    dueDate: "2026-09-15",
  ...
  {
    id: "m5s10",
    title: "Making LST Work Onsite: Communication",
    dueDate: "2026-09-22",
...
${TRAINING_CENTER_PROTOTYPE_ONSITE_HANDOUT_4_GROUPS}`,
  ...
  {
    id: "m5s6",
    title: "Making LST Work Onsite: Risk Management Video",
    dueDate: "2026-09-22",
  ...
  {
    id: "m5s11",
    title: "Making LST Work Onsite: Risk Management",
    dueDate: "2026-09-22",
  ...
  {
    id: "m5s12",
    title: "Making LST Work Onsite: Planning Parties",
    dueDate: "2026-09-22",
  ...
  {
    id: "m5s13",
    title: "Making LST Work Onsite: Reader Information Page",
    dueDate: "2026-09-22",
  ...
  {
    id: "m5s14",
    title: "Making LST Work Onsite: Before Departure",
    dueDate: "2026-09-22",
  ...
  {
    id: "m5s15",
    title: "Making LST Work Onsite: Sample LST Project Schedules",
    dueDate: "2026-09-22",
  ...
  {
    id: "m5s16",
    title: "Making LST Work Onsite: Sample Final Report",
    dueDate: "2026-09-22",
...
const TRAINING_CENTER_PROTOTYPE_MODULE_7_SECTIONS = [
  ...
  {
    id: "m7s2",
    title: "Debriefing and Reentry Video",
    dueDate: "2026-09-17",
...
Watch the video below on issues you'll negotiate as you settle in back home after your project. Watch this in preparation for your LST EndMeeting too.`,
  ...
  {
    id: "m7s3",
    title: "Debriefing and Reentry Discussion",
    dueDate: "2026-09-17",
...
export const TRAINING_CENTER_PROTOTYPE_QUIZ = [
  ...
  {
    id: "q3",
    prompt: "What does this training demonstrate?",
    options: [
      "Live production training data",
      "How Hub training modules and quizzes work",
...
/**
 * Team-level module status for staff/leaders.
 * - not_started: nobody has completed any section
 * - in_progress: at least one worker started, but not everyone finished the module
 * - completed: every worker finished every section (e.g. 3/3)
 */
export function getPrototypeModuleTeamStatus(module = null, participants = []) {
  const sections = module?.sections || [];
  const workers = Array.isArray(participants) ? participants : [];
  const workerCount = workers.length;
  const sectionCount = sections.length;

  if (!workerCount || !sectionCount) {
    return {
      status: "not_started",
      startedCount: 0,
      completedCount: 0,
  ...
  for (const participant of workers) {
    const state = participant?.sectionState || {};
    const done = sections.filter((section) => !!state[section.id]).length;
    if (done > 0) startedCount += 1;
    if (done >= sectionCount) completedCount += 1;
  }

  let status = "not_started";
  if (completedCount >= workerCount) status = "completed";
  else if (startedCount > 0) status = "in_progress";

  return { status, startedCount, completedCount, total: workerCount };
}

export function formatPrototypeModuleTeamStatusLabel(teamStatus) {
  const meta = PROTOTYPE_STATUS_META[teamStatus?.status] || PROTOTYPE_STATUS_META.not_started;
  const total = Number(teamStatus?.total) || 0;
  if (!total) return meta.label;
  if (teamStatus.status === "completed") {
    return `${meta.label} · ${teamStatus.completedCount}/${total}`;
  }
  if (teamStatus.status === "in_progress") {
    return `${meta.label} · ${teamStatus.startedCount}/${total}`;
  }
  return `${meta.label} · 0/${total}`;
}
...
/** Map a classroom / checklist module title to its prototype module id. */
export function findPrototypeModuleIdForTrainingTitle(title) {
  ...
  for (const [protoId, trainingTitle] of Object.entries(TRAINING_PROTOTYPE_MODULE_TO_TRAINING_TITLE)) {
    if (String(trainingTitle).trim().toLowerCase().replace(/\s+/g, " ") === normalized) {
      return protoId;
    }
  }

  const moduleNumberMatch = normalized.match(/^module\s+(\d+)\b/);
  if (moduleNumberMatch) {
    const protoId = `proto-module-${moduleNumberMatch[1]}`;
    if (getPrototypeModuleById(protoId)) return protoId;
  }
