...
/** Display order on Trip Documents: flights → travel → insurance → budget → site → housing (site card is rendered between budget and housing in the page). */
...
export const REQUIRED_TRIP_DOCUMENT_SLOTS = [
  ...
  {
    key: "team-travel-overview",
    title: "Travel",
    category: "Travel",
    kind: "link",
    description: "Optional team travel overview link (itinerary hub, group travel page, etc.).",
  },
  {
    key: "trip-insurance",
