...
/**
 * Site picker list: all built-in SITE_OPTIONS plus extra `site_budget_notes.site_name` rows
 * (e.g. from Sites → Add site) not already tied to a canonical option — **A–Z** by display label.
 */
