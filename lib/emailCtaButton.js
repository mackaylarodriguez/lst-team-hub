...
/** LST primary blue — shared accent for Hub transactional emails. */
export const EMAIL_BRAND_ACCENT = "#3254a3";
...
export function buildEmailCtaButton({ href, label }) {
  ...
  const accent = EMAIL_BRAND_ACCENT;

  return `<table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="margin:24px 0 0 0">
  <tr>
    <td align="center" style="padding:0;">
      <!--[if mso]>
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${safeUrl}" style="height:40px;v-text-anchor:middle;width:${vmlWidth}px;" arcsize="14%" stroke="f" fillcolor="${accent}">
        <w:anchorlock/>
